...
2. Download this collection from galaxy: `ansible-galaxy collection install fortinet.fortios:2.0.1`
...
|6.0.0|2.0.1 `latest`|2021/4/7|`ansible-galaxy collection install fortinet.fortios:2.0.1`|
