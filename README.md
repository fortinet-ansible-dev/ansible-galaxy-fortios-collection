...
2. Download this collection from galaxy: `ansible-galaxy collection install fortinet.fortios:1.0.15`
...
|----------|:-------------:|:-------------:|:------:|
|6.0.0|1.0.14 |2020/7/24|`ansible-galaxy collection install fortinet.fortios:1.0.14`|
|6.0.0|1.0.15 `latest`|2020/8/27|`ansible-galaxy collection install fortinet.fortios:1.0.15`|
