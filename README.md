...
2. Download this collection from galaxy: `ansible-galaxy collection install fortinet.fortios:2.1.1`
...
|6.0.0|2.1.1 `latest`|2021/6/29|`ansible-galaxy collection install fortinet.fortios:2.1.1`|
