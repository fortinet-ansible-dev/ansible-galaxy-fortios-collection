...
2. Download this collection from galaxy: `ansible-galaxy collection install fortinet.fortios:2.3.1`
...
The latest version is 2.3.1, path to install: `ansible-galaxy collection install fortinet.fortios:2.3.1`
