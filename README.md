...
2. Download this collection from galaxy: `ansible-galaxy collection install fortinet.fortios:2.0.0`
...
|6.0.0|2.0.0 `latest`|2021/4/6|`ansible-galaxy collection install fortinet.fortios:2.0.0`|
