...
2. Download this collection from galaxy: `ansible-galaxy collection install fortinet.fortios:1.1.5`
...
|6.0.0|1.1.5 `latest`|2020/12/7|`ansible-galaxy collection install fortinet.fortios:1.1.5`|
...
|6.4.0|1.1.4 `latest`|2020/12/7|`ansible-galaxy collection install fortinet.fortios:1.1.4`|
