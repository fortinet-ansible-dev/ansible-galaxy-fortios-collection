...
if __name__ == '__main__':
    assert is_same_ip_address("10.29.0.0", "10.29.0.0"), 'ip only'
    assert is_same_ip_address("10.29.0.0/24", "10.29.0.0/24"), 'slash and slash'
    assert is_same_ip_address("11.11.10.0 255.255.254.0", "11.11.10.0/23"), 'slash and space'
    assert is_same_ip_address("10.29.0.0/24", "10.29.0.0 255.255.255.0"), 'slash and space'
    assert is_same_ip_address("10.29.0.0/24", "10.29.0.0 255.255.255.0"), 'slash and space'
    assert is_same_ip_address("10.29.0.0", "10.29.0.0"), 'ip only'
    assert is_same_ip_address("10.29.0.0 255.255.255.0", "10.29.0.0 255.255.255.0"), 'space and space'
    assert is_same_ip_address("10.29.0.0 255.255.255.0", "10.29.0.0 255.255.255.0"), 'space and space'
    assert is_same_ip_address("10.29.0.0 255.255.255.0", "10.29.0.0 255.255.255.0"), 'space and space'
    assert is_same_ip_address(["10.29.0.0", "255.255.255.0"], "10.29.0.0 255.255.255.0"), 'space and space'
    assert is_same_ip_address(["10.29.0.0", "255.255.255.0"], "10.29.0.0/24"), 'space and space'