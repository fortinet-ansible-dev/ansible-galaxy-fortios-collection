...
versioned_schema = {
    ...
    "children": {
        ...
        "upgrade_mode": {
            ...
            "type": "string",
            "options": [
                {"value": "simultaneous", "revisions": {"v7.4.1": True}},
                {"value": "uninterruptible", "revisions": {"v7.4.1": True}},
                {"value": "local-only", "revisions": {"v7.4.1": True}},
                {"value": "secondary-only", "revisions": {"v7.4.1": True}},
            ],
        },
        "uninterruptible_primary_wait": {
            "revisions": {
