...
def filter_system_ha_data(json):
    option_list = ['arps', 'arps_interval', 'authentication',
                   ...
                   'pingserver_secondary_force_reset', 'pingserver_slave_force_reset', 'pop3_proxy_threshold',
                   'priority', 'route_hold', 'route_ttl',
                   'route_wait', 'schedule', 'secondary_vcluster',
                   'session_pickup', 'session_pickup_connectionless', 'session_pickup_delay',
                   'session_pickup_expectation', 'session_pickup_nat', 'session_sync_dev',
                   'smtp_proxy_threshold', 'ssd_failover', 'standalone_config_sync',
