...
module_selectors_defs = {
    "memory_event_connector": {
        ...
        "params": {
            "rows": {"type": "int", "required": ""},
            "extra": {"type": "string", "required": ""},
            "serial_no": {"type": "string", "required": ""},
            "session_id": {"type": "int", "required": ""},
            "filter": {"type": "string", "required": ""},
            "start": {"type": "int", "required": ""},
            "is_ha_member": {"type": "boolean", "required": ""},
        },
    },
    "memory_virus_archive": {
        "url": "memory/virus/archive",
        "params": {
            "mkey": {"type": "int", "required": ""},
