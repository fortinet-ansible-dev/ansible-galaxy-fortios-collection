        ...
        suboptions:
            ...
            ovrd_perm:
                ...
                choices:
                    - bannedword_override
                    - urlfilter_override
                    - fortiguard_wf_override
                    - contenttype_check_override
            post_action:
                description:
...
def flatten_multilists_attributes(data):
    multilist_attrs = [[u'ovrd_perm'], [u'web', u'whitelist'], [u'web', u'safe_search'], [u'ftgd_wf', u'options'], [u'file_filter', u'entries', u'protocol'],
                       [u'options']]
