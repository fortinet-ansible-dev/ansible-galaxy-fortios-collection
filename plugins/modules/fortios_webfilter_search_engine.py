...
options:
    ...
    webfilter_search_engine:
        ...
        suboptions:
            ...
            safesearch_str:
                description:
                    - In URL mode, it is the safe search parameter used in the URL. In translate mode, it provides either the regex to translate the URL, or
                       the special case to translate the URL
                type: str
            url:
                description:
