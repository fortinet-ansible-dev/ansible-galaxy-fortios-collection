  ...
  - name: Show Internet Service application.
    fortios_firewall_internet_service:
      ...
      firewall_internet_service:
        ...
        ip_range_number: "15"
        jitter_threshold: "16"
        latency_threshold: "17"
        name: "default_name_18"
        obsolete: "19"
        offset: "20"
        packetloss_threshold: "21"
        reputation: "22"
        singularity: "23"
        sld_id: "24"
...
def filter_firewall_internet_service_data(json):
    option_list = ['database', 'direction', 'entry',
                   ...
                   'ip_number', 'ip_range_number', 'jitter_threshold',
                   'latency_threshold', 'name', 'obsolete',
                   'offset', 'packetloss_threshold', 'reputation',
                   'singularity', 'sld_id']
    dictionary = {}
