...
def filter_system_ipam_data(json):
    option_list = ['pool_subnet', 'server_type', 'status']
    dictionary = {}
...
def main():
    ...
    for attribute_name in module_spec['options']:
        fields["system_ipam"]['options'][attribute_name] = module_spec['options'][attribute_name]
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(fos, versioned_schema, "system_ipam")
