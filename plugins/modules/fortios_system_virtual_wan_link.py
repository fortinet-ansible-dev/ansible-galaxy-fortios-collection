        ...
        suboptions:
            ...
            load_balance_mode:
                ...
                choices:
                    ...
                    - weight_based
                    - usage_based
                    - source_dest_ip_based
                    - measured_volume_based
            members:
                description:
      ...
      system_virtual_wan_link:
        ...
        health_check:
         -
            ...
            internet_service_id: "15 (source firewall.internet-service.id)"
            interval: "16"
            members:
             -
                seq_num: "18 (source system.virtual-wan-link.members.seq-num)"
            ...
            sla:
             -
                id:  "31"
                jitter_threshold: "32"
                latency_threshold: "33"
                link_cost_factor: "latency"
                packetloss_threshold: "35"
            sla_fail_log_period: "36"
            sla_pass_log_period: "37"
            system_dns: "disable"
            threshold_alert_jitter: "39"
            threshold_alert_latency: "40"
            threshold_alert_packetloss: "41"
            threshold_warning_jitter: "42"
            threshold_warning_latency: "43"
            threshold_warning_packetloss: "44"
        ...
        members:
         -
            ...
            ingress_spillover_threshold: "53"
            interface: "<your_own_value> (source system.interface.name)"
            priority: "55"
            seq_num: "56"
            source: "<your_own_value>"
            source6: "<your_own_value>"
            spillover_threshold: "59"
            status: "disable"
            volume_ratio: "61"
            weight: "62"
        neighbor:
         -
            ...
            member: "66 (source system.virtual-wan-link.members.seq-num)"
            role: "standalone"
            sla_id: "68"
        neighbor_hold_boot_time: "69"
        neighbor_hold_down: "enable"
        neighbor_hold_down_time: "71"
        service:
         -
            addr_mode: "ipv4"
            bandwidth_weight: "74"
            ...
            groups:
             -
                name: "default_name_88 (source user.group.name)"
            health_check: "<your_own_value> (source system.virtual-wan-link.health-check.name)"
            hold_down_time: "90"
            id:  "91"
            input_device:
            ...
            internet_service_ctrl_group:
             -
                name: "default_name_103 (source application.group.name)"
            internet_service_custom:
             -
                name: "default_name_105 (source firewall.internet-service-custom.name)"
            internet_service_custom_group:
             -
                name: "default_name_107 (source firewall.internet-service-custom-group.name)"
            internet_service_group:
             -
                name: "default_name_109 (source firewall.internet-service-group.name)"
            internet_service_id:
             -
                id:  "111 (source firewall.internet-service.id)"
            internet_service_name:
             -
            ...
            latency_weight: "115"
            link_cost_factor: "latency"
            link_cost_threshold: "117"
            member: "118 (source system.virtual-wan-link.members.seq-num)"
            mode: "auto"
            name: "default_name_120"
            packet_loss_weight: "121"
            priority_members:
             -
                seq_num: "123 (source system.virtual-wan-link.members.seq-num)"
            protocol: "124"
            quality_link: "125"
            role: "standalone"
            route_tag: "127"
            ...
            src6:
             -
                name: "default_name_136 (source firewall.address6.name firewall.addrgrp6.name)"
            ...
            users:
             -
                name: "default_name_143 (source user.local.name)"
        status: "disable"
