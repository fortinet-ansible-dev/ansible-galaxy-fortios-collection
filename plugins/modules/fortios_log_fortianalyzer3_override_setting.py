  ...
  - name: Override FortiAnalyzer settings.
    fortios_log_fortianalyzer3_override_setting:
      ...
      log_fortianalyzer3_override_setting:
        ...
        monitor_failure_retry_period: "14"
        monitor_keepalive_period: "15"
        override: "enable"
        priority: "default"
        reliable: "enable"
        serial:
...
def filter_log_fortianalyzer3_override_setting_data(json):
    option_list = ['__change_ip', 'access_config', 'certificate',
                   ...
                   'max_log_rate', 'mgmt_name', 'monitor_failure_retry_period',
                   'monitor_keepalive_period', 'override', 'priority',
