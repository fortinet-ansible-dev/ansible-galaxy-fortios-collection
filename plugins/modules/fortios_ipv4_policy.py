...
from ansible_collections.fortinet.fortios.plugins.module_utils.fortios.fortios import fortios_argument_spec, fortios_required_if
from ansible_collections.fortinet.fortios.plugins.module_utils.fortios.fortios import AnsibleFortios
