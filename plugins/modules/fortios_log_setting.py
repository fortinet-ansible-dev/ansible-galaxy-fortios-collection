...
def filter_log_setting_data(json):
    option_list = ['anonymization_hash', 'brief_traffic_format', 'custom_log_fields',
                   'daemon_log', 'expolicy_implicit_log', 'faz_override',
                   'fortiview_weekly_data', 'fwpolicy_implicit_log', 'fwpolicy6_implicit_log',
                   ...
                   'resolve_ip', 'resolve_port', 'rest_api_get',
                   'rest_api_set', 'syslog_override', 'user_anonymize']
    dictionary = {}
