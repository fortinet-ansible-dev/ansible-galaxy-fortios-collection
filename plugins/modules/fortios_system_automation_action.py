...
def filter_system_automation_action_data(json):
    option_list = ['accprofile', 'action_type', 'alicloud_access_key_id',
                   ...
                   'email_to', 'execute_security_fabric', 'gcp_function',
                   'gcp_function_domain', 'gcp_function_region', 'gcp_project',
                   'headers', 'http_body', 'message',
                   'message_type', 'method', 'minimum_interval',
                   'name', 'port', 'protocol',
                   'replacement_message', 'replacemsg_group', 'required',
                   'script', 'sdn_connector', 'security_tag',
                   'tls_certificate', 'uri', 'verify_host_cert']
    dictionary = {}
