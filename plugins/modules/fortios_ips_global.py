...
def filter_ips_global_data(json):
    option_list = ['anomaly_mode', 'cp_accel_mode', 'database',
                   ...
                   'ips_reserve_cpu', 'np_accel_mode', 'packet_log_queue_depth',
                   'session_limit_mode', 'skype_client_public_ipaddr', 'socket_size',
                   'sync_session_ttl', 'traffic_submit']
    dictionary = {}
