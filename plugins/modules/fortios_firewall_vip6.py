...
def filter_firewall_vip6_data(json):
    option_list = ['add_nat64_route', 'arp_reply', 'color',
                   ...
                   'src_filter', 'ssl_accept_ffdhe_groups', 'ssl_algorithm',
                   ...
                   'ssl_server_session_state_timeout', 'ssl_server_session_state_type', 'type',
                   'uuid', 'weblogic_server', 'websphere_server']
    dictionary = {}
