...
def filter_wireless_controller_vap_data(json):
    option_list = ['acct_interim_interval', 'alias', 'auth',
                   ...
                   'radius_mac_auth', 'radius_mac_auth_server', 'radius_server',
                   'rates_11a', 'rates_11ac_ss12', 'rates_11ac_ss34',
                   'rates_11bg', 'rates_11n_ss12', 'rates_11n_ss34',
                   'schedule', 'security', 'security_exempt_list',
                   'security_obsolete_option', 'security_redirect_url', 'selected_usergroups',
                   'split_tunneling', 'ssid', 'tkip_counter_measure',
                   'usergroup', 'utm_profile', 'vdom',
                   'vlan_auto', 'vlan_pool', 'vlan_pooling',
                   'vlanid', 'voice_enterprise']
    dictionary = {}
