...
def filter_wireless_controller_vap_data(json):
    option_list = ['access_control_list', 'acct_interim_interval', 'address_group',
                   ...
                   'captive_portal_session_timeout_interval', 'dhcp_lease_time', 'dhcp_option43_insertion',
                   ...
                   'ipv6_rules', 'key', 'keyindex',
                   'ldpc', 'local_authentication', 'local_bridging',
                   'local_lan', 'local_standalone', 'local_standalone_nat',
                   'mac_auth_bypass', 'mac_filter', 'mac_filter_list',
                   'mac_filter_policy_other', 'max_clients', 'max_clients_ap',
                   'me_disable_thresh', 'mesh_backhaul', 'mpsk',
                   'mpsk_concurrent_clients', 'mpsk_key', 'mpsk_profile',
                   ...
                   'port_macauth', 'port_macauth_reauth_timeout', 'port_macauth_timeout',
