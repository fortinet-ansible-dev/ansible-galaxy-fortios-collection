        ...
        suboptions:
            ...
            security:
                ...
                choices:
                    ...
                    - wep128
                    - wpa_personal
                    - wpa_personal+captive_portal
                    - wpa_enterprise
                    - wpa_only_personal
                    - wpa_only_personal+captive_portal
                    - wpa_only_enterprise
                    - wpa2_only_personal
                    - wpa2_only_personal+captive_portal
                    - wpa2_only_enterprise
                    - osen
                    - wpa3_enterprise
                    - wpa3_sae
                    - wpa3_sae_transition
  ...
  - name: Configure Virtual Access Points (VAPs).
    fortios_wireless_controller_vap:
      ...
      wireless_controller_vap:
        ...
        captive_portal_auth_timeout: "12"
        ...
        captive_portal_session_timeout_interval: "17"
        dhcp_lease_time: "18"
        ...
        fast_roaming: "enable"
        ft_mobility_domain: "34"
        ft_over_ds: "disable"
        ft_r0_key_lifetime: "36"
        gtk_rekey: "enable"
        gtk_rekey_intv: "38"
        ...
        max_clients: "59"
        max_clients_ap: "60"
        me_disable_thresh: "61"
        mesh_backhaul: "enable"
        mpsk: "enable"
        mpsk_concurrent_clients: "64"
        mpsk_key:
         -
            comment: "Comment."
            ...
            mpsk_schedules:
             -
                name: "default_name_70 (source firewall.schedule.group.name firewall.schedule.recurring.name firewall.schedule.onetime.name)"
        ...
        passphrase: "<your_own_value>"
        pmf: "disable"
        pmf_assoc_comeback_timeout: "82"
        pmf_sa_query_retry_timeout: "83"
        ...
        selected_usergroups:
         -
            name: "default_name_121 (source user.group.name)"
        ...
        tunnel_echo_interval: "129"
        tunnel_fallback_interval: "130"
        usergroup:
         -
            name: "default_name_132 (source user.group.name)"
...
def filter_wireless_controller_vap_data(json):
    option_list = ['access_control_list', 'acct_interim_interval', 'address_group',
                   'alias', 'atf_weight', 'auth',
                   'broadcast_ssid', 'broadcast_suppression', 'captive_portal_ac_name',
                   'captive_portal_auth_timeout', 'captive_portal_macauth_radius_secret', 'captive_portal_macauth_radius_server',
                   'captive_portal_radius_secret', 'captive_portal_radius_server', 'captive_portal_session_timeout_interval',
                   ...
                   'high_efficiency', 'hotspot20_profile', 'intra_vap_privacy',
                   'ip', 'ipv6_rules', 'key',
                   ...
                   'mu_mimo', 'multicast_enhance', 'multicast_rate',
                   'name', 'okc', 'owe_groups',
                   'owe_transition', 'owe_transition_ssid', 'passphrase',
                   ...
                   'primary_wag_profile', 'probe_resp_suppression', 'probe_resp_threshold',
                   'ptk_rekey', 'ptk_rekey_intv', 'qos_profile',
                   'quarantine', 'radio_2g_threshold', 'radio_5g_threshold',
                   'radio_sensitivity', 'radius_mac_auth', 'radius_mac_auth_server',
                   'radius_mac_auth_usergroups', 'radius_server', 'rates_11a',
                   'rates_11ac_ss12', 'rates_11ac_ss34', 'rates_11bg',
                   'rates_11n_ss12', 'rates_11n_ss34', 'sae_groups',
                   'sae_password', 'schedule', 'secondary_wag_profile',
                   ...
                   'utm_profile', 'vdom', 'vlan_auto',
                   'vlan_pool', 'vlan_pooling', 'vlanid',
                   'voice_enterprise']
    dictionary = {}
...
def flatten_multilists_attributes(data):
    multilist_attrs = [[u'rates_11ac_ss34'], [u'rates_11a'], [u'ipv6_rules'], [u'rates_11n_ss34'], [u'owe_groups'], [u'rates_11n_ss12'],
                       [u'broadcast_suppression'], [u'sae_groups'], [u'rates_11ac_ss12'], [u'rates_11bg']]
