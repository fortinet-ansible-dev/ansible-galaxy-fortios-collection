...
def filter_wireless_controller_vap_data(json):
    option_list = ['access_control_list', 'acct_interim_interval', 'additional_akms',
                   ...
                   'auth_cert', 'auth_portal_addr', 'beacon_advertising',
                   ...
                   'osen', 'owe_groups', 'owe_transition',
                   ...
                   'radius_mac_mpsk_auth', 'radius_mac_mpsk_timeout', 'radius_server',
                   'rates_11a', 'rates_11ac_ss12', 'rates_11ac_ss34',
                   'rates_11ax_ss12', 'rates_11ax_ss34', 'rates_11bg',
                   'rates_11n_ss12', 'rates_11n_ss34', 'sae_groups',
                   'sae_password', 'scan_botnet_connections', 'schedule',
                   'secondary_wag_profile', 'security', 'security_exempt_list',
                   'security_obsolete_option', 'security_redirect_url', 'selected_usergroups',
                   'split_tunneling', 'ssid', 'sticky_client_remove',
                   'sticky_client_threshold_2g', 'sticky_client_threshold_5g', 'target_wake_time',
                   'tkip_counter_measure', 'tunnel_echo_interval', 'tunnel_fallback_interval',
                   'usergroup', 'utm_log', 'utm_profile',
                   'utm_status', 'vdom', 'vlan_auto',
                   'vlan_name', 'vlan_pool', 'vlan_pooling',
...
def flatten_multilists_attributes(data):
    multilist_attrs = [
        ...
        [u'owe_groups'],
        [u'rates_11ax_ss12'],
        [u'local_standalone_dns_ip'],
        [u'rates_11n_ss12'],
        [u'beacon_advertising'],
