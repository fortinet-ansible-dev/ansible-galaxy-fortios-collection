    ...
    fortios_emailfilter_profile:
      ...
      emailfilter_profile:
        ...
        smtp:
            ...
            tag_msg: "<your_own_value>"
            tag_type: "subject"
        spam_bwl_table: "46 (source emailfilter.bwl.id)"
        spam_bword_table: "47 (source emailfilter.bword.id)"
        spam_bword_threshold: "48"
        spam_filtering: "enable"
        spam_iptrust_table: "50 (source emailfilter.iptrust.id)"
        spam_log: "disable"
        spam_log_fortiguard_response: "disable"
        spam_mheader_table: "53 (source emailfilter.mheader.id)"
        spam_rbl_table: "54 (source emailfilter.dnsbl.id)"
        yahoo_mail:
            log: "enable"
