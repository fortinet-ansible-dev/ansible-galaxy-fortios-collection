      ...
      switch_controller_managed_switch:
        ...
        ports:
         -
            ...
            sample_direction: "tx"
            sflow_counter_interval: "115"
            sflow_sample_rate: "116"
        ...
        snmp_sysinfo:
            ...
            status: "disable"
        snmp_trap_threshold:
            trap_high_cpu_threshold: "170"
            trap_log_full_threshold: "171"
            trap_low_memory_threshold: "172"
        snmp_user:
         -
            auth_proto: "md5"
...
def filter_switch_controller_managed_switch_data(json):
    option_list = ['settings_802_1X', 'access_profile', 'connected',
                   'custom_command', 'delayed_restart_trigger', 'description',
                   'directly_connected', 'dynamic_capability', 'dynamically_discovered',
                   'flow_identity', 'fsw_wan1_admin', 'fsw_wan1_peer',
                   'fsw_wan2_admin', 'fsw_wan2_peer', 'igmp_snooping',
                   'ip_source_guard', 'l3_discovered', 'max_allowed_trunk_members',
                   'mclag_igmp_snooping_aware', 'mirror', 'name',
                   'override_snmp_community', 'override_snmp_sysinfo', 'override_snmp_trap_threshold',
                   'override_snmp_user', 'owner_vdom', 'poe_detection_type',
                   'poe_lldp_detection', 'poe_pre_standard_detection', 'ports',
                   'pre_provisioned', 'qos_drop_policy', 'qos_red_probability',
                   'remote_log', 'snmp_community', 'snmp_sysinfo',
                   'snmp_trap_threshold', 'snmp_user', 'staged_image_version',
                   'static_mac', 'storm_control', 'stp_instance',
                   'stp_settings', 'switch_device_tag', 'switch_dhcp_opt43_key',
