...
def filter_firewall_proxy_policy_data(json):
    option_list = ['access_proxy', 'access_proxy6', 'action',
                   'application_list', 'av_profile', 'block_notification',
                   'cifs_profile', 'comments', 'decrypted_traffic_mirror',
                   'device_ownership', 'disclaimer', 'dlp_sensor',
                   'dstaddr', 'dstaddr_negate', 'dstaddr6',
                   'dstintf', 'emailfilter_profile', 'file_filter_profile',
                   ...
                   'internet_service_name', 'internet_service_negate', 'ips_sensor',
                   'label', 'logtraffic', 'logtraffic_start',
                   'mms_profile', 'name', 'policyid',
                   'poolname', 'profile_group', 'profile_protocol_options',
                   'profile_type', 'proxy', 'redirect_url',
                   'replacemsg_override_group', 'scan_botnet_connections', 'schedule',
                   'sctp_filter_profile', 'service', 'service_negate',
                   'session_ttl', 'spamfilter_profile', 'srcaddr',
                   ...
                   'voip_profile', 'waf_profile', 'webcache',
                   'webcache_https', 'webfilter_profile', 'webproxy_forward_server',
                   'webproxy_profile', 'ztna_ems_tag', 'ztna_tags_match_logic']
    dictionary = {}
