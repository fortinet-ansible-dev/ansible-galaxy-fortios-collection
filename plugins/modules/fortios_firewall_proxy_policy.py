...
def filter_firewall_proxy_policy_data(json):
    option_list = ['access_proxy', 'action', 'application_list',
                   'av_profile', 'cifs_profile', 'comments',
                   'decrypted_traffic_mirror', 'device_ownership', 'disclaimer',
                   'dlp_sensor', 'dstaddr', 'dstaddr_negate',
                   'dstaddr6', 'dstintf', 'emailfilter_profile',
                   'file_filter_profile', 'global_label', 'groups',
                   ...
                   'profile_protocol_options', 'profile_type', 'proxy',
                   'redirect_url', 'replacemsg_override_group', 'scan_botnet_connections',
