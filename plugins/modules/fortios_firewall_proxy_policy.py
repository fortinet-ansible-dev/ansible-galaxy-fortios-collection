  ...
  - name: Configure proxy policies.
    fortios_firewall_proxy_policy:
      ...
      firewall_proxy_policy:
        ...
        poolname:
         -
            name: "default_name_43 (source firewall.ippool.name)"
        ...
        srcaddr:
         -
            name: "default_name_58 (source firewall.address.name firewall.addrgrp.name firewall.proxy-address.name firewall.proxy-addrgrp.name system
              .external-resource.name)"
        srcaddr_negate: "enable"
        srcaddr6:
         -
            name: "default_name_61 (source firewall.address6.name firewall.addrgrp6.name system.external-resource.name)"
        srcintf:
         -
