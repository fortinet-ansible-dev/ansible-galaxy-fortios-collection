...
def filter_system_dhcp6_server_data(json):
    option_list = ['delegated_prefix_iaid', 'dns_search_list', 'dns_server1',
                   'dns_server2', 'dns_server3', 'dns_server4',
                   'dns_service', 'domain', 'id',
                   'interface', 'ip_mode', 'ip_range',
                   'lease_time', 'option1', 'option2',
                   'option3', 'prefix_mode', 'prefix_range',
