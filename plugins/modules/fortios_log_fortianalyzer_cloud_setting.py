...
def filter_log_fortianalyzer_cloud_setting_data(json):
    option_list = ['__change_ip', 'access_config', 'certificate',
                   ...
                   'monitor_failure_retry_period', 'monitor_keepalive_period', 'priority',
...
def main():
    ...
    if module._socket_path:
        ...
        is_error, has_changed, result = fortios_log_fortianalyzer_cloud(module.params, fos, module.check_mode)
