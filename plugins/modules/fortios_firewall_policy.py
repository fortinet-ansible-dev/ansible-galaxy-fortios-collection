...
def filter_firewall_policy_data(json):
    option_list = ['action', 'anti_replay', 'app_category',
                   ...
                   'email_collect', 'emailfilter_profile', 'fec',
                   'file_filter_profile', 'firewall_session_dirty', 'fixedport',
                   'fsso', 'fsso_agent_for_ntlm', 'fsso_groups',
                   'geoip_anycast', 'geoip_match', 'global_label',
                   'groups', 'gtp_profile', 'http_policy_redirect',
                   ...
                   'learning_mode', 'logtraffic', 'logtraffic_start',
                   'match_vip', 'match_vip_only', 'mms_profile',
                   'name', 'nat', 'nat46',
                   'nat64', 'natinbound', 'natip',
                   'natoutbound', 'np_acceleration', 'ntlm',
                   'ntlm_enabled_browsers', 'ntlm_guest', 'outbound',
                   'passive_wan_health_measurement', 'per_ip_shaper', 'permit_any_host',
                   'permit_stun_host', 'pfcp_profile', 'policyid',
                   'poolname', 'poolname6', 'profile_group',
                   'profile_protocol_options', 'profile_type', 'radius_mac_auth_bypass',
                   'redirect_url', 'replacemsg_override_group', 'reputation_direction',
                   'reputation_minimum', 'rsso', 'rtp_addr',
                   'rtp_nat', 'scan_botnet_connections', 'schedule',
                   'schedule_timeout', 'sctp_filter_profile', 'send_deny_packet',
                   'service', 'service_negate', 'session_ttl',
                   'sgt', 'sgt_check', 'spamfilter_profile',
                   'src_vendor_mac', 'srcaddr', 'srcaddr_negate',
                   ...
                   'videofilter_profile', 'vlan_cos_fwd', 'vlan_cos_rev',
                   ...
                   'wsso', 'ztna_ems_tag', 'ztna_geo_tag',
                   'ztna_status']
    dictionary = {}
