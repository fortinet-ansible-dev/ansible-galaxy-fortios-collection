  ...
  - name: Configure IPv4 policies.
    fortios_firewall_policy:
      ...
      firewall_policy:
        ...
        poolname:
         -
            name: "default_name_114 (source firewall.ippool.name)"
        poolname6:
         -
            name: "default_name_116 (source firewall.ippool6.name)"
        ...
        reputation_minimum: "124 (source firewall.internet-service-reputation.id)"
        rsso: "enable"
        rtp_addr:
         -
        ...
        service:
         -
            name: "default_name_134 (source firewall.service.custom.name firewall.service.group.name)"
        service_negate: "enable"
        session_ttl: "136"
        spamfilter_profile: "<your_own_value> (source spamfilter.profile.name)"
        src_vendor_mac:
         -
            id:  "139 (source firewall.vendor-mac.id)"
        srcaddr:
         -
            name: "default_name_141 (source firewall.address.name firewall.addrgrp.name)"
        srcaddr_negate: "enable"
        srcaddr6:
         -
            name: "default_name_144 (source firewall.address6.name firewall.addrgrp6.name system.external-resource.name)"
        srcintf:
         -
            name: "default_name_146 (source system.interface.name system.zone.name)"
        ssh_filter_profile: "<your_own_value> (source ssh-filter.profile.name)"
        ssh_policy_redirect: "enable"
        ssl_mirror: "enable"
        ssl_mirror_intf:
         -
            name: "default_name_151 (source system.interface.name system.zone.name)"
        ssl_ssh_profile: "<your_own_value> (source firewall.ssl-ssh-profile.name)"
        status: "enable"
        tcp_mss_receiver: "154"
        tcp_mss_sender: "155"
        ...
        users:
         -
            name: "default_name_166 (source user.local.name)"
        utm_status: "enable"
        uuid: "<your_own_value>"
        vlan_cos_fwd: "169"
        vlan_cos_rev: "170"
...
def filter_firewall_policy_data(json):
    option_list = ['action', 'anti_replay', 'app_category',
                   ...
                   'dstaddr6', 'dstintf', 'email_collect',
                   'emailfilter_profile', 'file_filter_profile', 'firewall_session_dirty',
                   'fixedport', 'fsso', 'fsso_agent_for_ntlm',
                   'fsso_groups', 'geoip_anycast', 'geoip_match',
                   'global_label', 'groups', 'gtp_profile',
                   'http_policy_redirect', 'icap_profile', 'identity_based_route',
                   'inbound', 'inspection_mode', 'internet_service',
                   'internet_service_custom', 'internet_service_custom_group', 'internet_service_group',
                   'internet_service_id', 'internet_service_name', 'internet_service_negate',
                   'internet_service_src', 'internet_service_src_custom', 'internet_service_src_custom_group',
                   'internet_service_src_group', 'internet_service_src_id', 'internet_service_src_name',
                   'internet_service_src_negate', 'ippool', 'ips_sensor',
                   'label', 'learning_mode', 'logtraffic',
                   'logtraffic_start', 'match_vip', 'match_vip_only',
                   'name', 'nat', 'natinbound',
                   'natip', 'natoutbound', 'np_acceleration',
                   ...
                   'session_ttl', 'spamfilter_profile', 'src_vendor_mac',
