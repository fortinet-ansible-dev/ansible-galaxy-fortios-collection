...
def wireless_controller_hotspot20_h2qp_conn_capability(data, fos, check_mode=False):
    ...
    if check_mode:
        ...
        mkey = fos.get_mkey('wireless-controller.hotspot20', 'h2qp-conn-capability', filtered_data, vdom=vdom)
        current_data = fos.get('wireless-controller.hotspot20', 'h2qp-conn-capability', vdom=vdom, mkey=mkey)
