  ...
  - name: Configure IPv6 policies.
    fortios_firewall_policy6:
      ...
      firewall_policy6:
        ...
        devices:
         -
            name: "default_name_20 (source user.device.alias user.device-group.name user.device-category.name)"
        ...
        dstaddr:
         -
            name: "default_name_32 (source firewall.address6.name firewall.addrgrp6.name firewall.vip6.name firewall.vipgrp6.name)"
        dstaddr_negate: "enable"
        dstintf:
         -
            name: "default_name_35 (source system.interface.name system.zone.name)"
        emailfilter_profile: "<your_own_value> (source emailfilter.profile.name)"
        firewall_session_dirty: "check_all"
        fixedport: "enable"
        fsso_groups:
         -
            name: "default_name_40 (source user.adgrp.name)"
        global_label: "<your_own_value>"
        groups:
         -
            name: "default_name_43 (source user.group.name)"
        ...
        poolname:
         -
            name: "default_name_61 (source firewall.ippool6.name)"
        ...
        srcintf:
         -
            name: "default_name_78 (source system.zone.name system.interface.name)"
        ssh_filter_profile: "<your_own_value> (source ssh-filter.profile.name)"
        ssh_policy_redirect: "enable"
        ssl_mirror: "enable"
        ssl_mirror_intf:
         -
            name: "default_name_83 (source system.zone.name system.interface.name)"
        ...
        users:
         -
            name: "default_name_98 (source user.local.name)"
        utm_status: "enable"
        uuid: "<your_own_value>"
        vlan_cos_fwd: "101"
        vlan_cos_rev: "102"
...
def filter_firewall_policy6_data(json):
    option_list = ['action', 'anti_replay', 'app_category',
                   ...
                   'dnsfilter_profile', 'dscp_match', 'dscp_negate',
                   'dscp_value', 'dsri', 'dstaddr',
                   'dstaddr_negate', 'dstintf', 'emailfilter_profile',
                   'firewall_session_dirty', 'fixedport', 'fsso_groups',
                   ...
                   'ssh_filter_profile', 'ssh_policy_redirect', 'ssl_mirror',
                   'ssl_mirror_intf', 'ssl_ssh_profile', 'status',
                   'tcp_mss_receiver', 'tcp_mss_sender', 'tcp_session_without_syn',
                   'timeout_send_rst', 'tos', 'tos_mask',
                   'tos_negate', 'traffic_shaper', 'traffic_shaper_reverse',
