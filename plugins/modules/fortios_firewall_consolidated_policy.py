  ...
  - name: Configure consolidated IPv4/IPv6 policies.
    fortios_firewall_consolidated_policy:
      ...
      firewall_consolidated_policy:
        ...
        dstaddr4:
         -
            name: "default_name_24 (source firewall.address.name firewall.addrgrp.name firewall.vip.name firewall.vipgrp.name system.external-resource.name)"
        dstaddr6:
         -
            name: "default_name_26 (source firewall.address6.name firewall.addrgrp6.name firewall.vip6.name firewall.vipgrp6.name system.external-resource
              .name)"
        dstintf:
         -
        ...
        internet_service_src_group:
         -
            name: "default_name_58 (source firewall.internet-service-group.name)"
        internet_service_src_id:
         -
            id:  "60 (source firewall.internet-service.id)"
        internet_service_src_name:
         -
            name: "default_name_62 (source firewall.internet-service-name.name)"
        ...
        service:
         -
            name: "default_name_82 (source firewall.service.custom.name firewall.service.group.name)"
        service_negate: "enable"
        session_ttl: "84"
        srcaddr_negate: "enable"
        srcaddr4:
         -
            name: "default_name_87 (source firewall.address.name firewall.addrgrp.name system.external-resource.name)"
        srcaddr6:
         -
            name: "default_name_89 (source firewall.address6.name firewall.addrgrp6.name system.external-resource.name)"
        srcintf:
         -
            name: "default_name_91 (source system.interface.name system.zone.name)"
        ...
        users:
         -
            name: "default_name_103 (source user.local.name)"
        utm_status: "enable"
        uuid: "<your_own_value>"
...
def filter_firewall_consolidated_policy_data(json):
    option_list = ['action', 'app_category', 'app_group',
                   'application', 'application_list', 'auto_asic_offload',
                   ...
                   'wanopt_profile', 'webcache', 'webcache_https',
