...
def filter_system_settings_data(json):
    option_list = ['allow_linkdown_path', 'allow_subnet_overlap', 'application_bandwidth_tracking',
                   ...
                   'gui_wireless_controller', 'gui_ztna', 'h323_direct_model',
                   'http_external_dest', 'ike_dn_format', 'ike_policy_route',
                   'ike_port', 'ike_quick_crash_detect', 'ike_session_resume',
                   'implicit_allow_dns', 'inspection_mode', 'ip',
                   'ip6', 'link_down_access', 'lldp_reception',
                   'lldp_transmission', 'location_id', 'mac_ttl',
                   'manageip', 'manageip6', 'multicast_forward',
                   'multicast_skip_policy', 'multicast_ttl_notchange', 'ngfw_mode',
                   'opmode', 'pfcp_monitor_mode', 'prp_trailer_action',
