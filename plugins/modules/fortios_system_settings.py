...
def filter_system_settings_data(json):
    option_list = ['allow_linkdown_path', 'allow_subnet_overlap', 'asymroute',
                   ...
                   'compliance_check', 'consolidated_firewall_mode', 'default_voip_alg_mode',
                   'deny_tcp_with_icmp', 'device', 'dhcp_proxy',
                   'dhcp_proxy_interface', 'dhcp_proxy_interface_select_method', 'dhcp_server_ip',
                   'dhcp6_server_ip', 'discovered_device_timeout', 'ecmp_max_paths',
                   'email_portal_check_dns', 'firewall_session_dirty', 'fw_session_hairpin',
                   'gateway', 'gateway6', 'gtp_asym_fgsp',
                   'gtp_monitor_mode', 'gui_advanced_policy', 'gui_allow_unnamed_policy',
                   ...
                   'gui_explicit_proxy', 'gui_file_filter', 'gui_fortiap_split_tunneling',
                   ...
                   'gui_per_policy_disclaimer', 'gui_policy_based_ipsec', 'gui_policy_disclaimer',
                   'gui_policy_learning', 'gui_replacement_message_groups', 'gui_security_profile_group',
                   'gui_spamfilter', 'gui_sslvpn_personal_bookmarks', 'gui_sslvpn_realms',
                   'gui_switch_controller', 'gui_threat_weight', 'gui_traffic_shaping',
                   'gui_voip_profile', 'gui_vpn', 'gui_waf_profile',
                   'gui_wan_load_balancing', 'gui_wanopt_cache', 'gui_webfilter',
                   'gui_webfilter_advanced', 'gui_wireless_controller', 'http_external_dest',
                   'ike_dn_format', 'ike_quick_crash_detect', 'ike_session_resume',
                   'implicit_allow_dns', 'inspection_mode', 'ip',
