...
def filter_system_settings_data(json):
    option_list = ['allow_subnet_overlap', 'asymroute', 'asymroute_icmp',
                   'asymroute6', 'asymroute6_icmp', 'bfd',
                   'bfd_desired_min_tx', 'bfd_detect_mult', 'bfd_dont_enforce_src_port',
                   'bfd_required_min_rx', 'block_land_attack', 'central_nat',
                   'comments', 'compliance_check', 'default_voip_alg_mode',
                   'deny_tcp_with_icmp', 'device', 'dhcp_proxy',
                   ...
                   'gui_advanced_policy', 'gui_allow_unnamed_policy', 'gui_antivirus',
                   'gui_ap_profile', 'gui_application_control', 'gui_default_policy_columns',
                   'gui_dhcp_advanced', 'gui_dlp', 'gui_dns_database',
                   'gui_dnsfilter', 'gui_domain_ip_reputation', 'gui_dos_policy',
                   'gui_dynamic_profile_display', 'gui_dynamic_routing', 'gui_email_collection',
                   'gui_endpoint_control', 'gui_endpoint_control_advanced', 'gui_explicit_proxy',
                   ...
                   'gui_object_colors', 'gui_policy_based_ipsec', 'gui_policy_learning',
                   'gui_replacement_message_groups', 'gui_spamfilter', 'gui_sslvpn_personal_bookmarks',
                   'gui_sslvpn_realms', 'gui_switch_controller', 'gui_threat_weight',
                   'gui_traffic_shaping', 'gui_voip_profile', 'gui_vpn',
                   'gui_waf_profile', 'gui_wan_load_balancing', 'gui_wanopt_cache',
                   'gui_webfilter', 'gui_webfilter_advanced', 'gui_wireless_controller',
                   'http_external_dest', 'ike_dn_format', 'ike_quick_crash_detect',
                   ...
                   'sccp_port', 'ses_denied_traffic', 'sip_helper',
