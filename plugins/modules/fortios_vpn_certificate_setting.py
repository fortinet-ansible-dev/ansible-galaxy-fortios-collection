...
def filter_vpn_certificate_setting_data(json):
    option_list = ['certname_dsa1024', 'certname_dsa2048', 'certname_ecdsa256',
                   ...
                   'cmp_key_usage_checking', 'cmp_save_extra_certs', 'cn_match',
                   'ocsp_default_server', 'ocsp_option', 'ocsp_status',
                   'ssl_min_proto_version', 'ssl_ocsp_option', 'ssl_ocsp_source_ip',
                   'ssl_ocsp_status', 'strict_crl_check', 'strict_ocsp_check',
                   'subject_match']
    dictionary = {}
