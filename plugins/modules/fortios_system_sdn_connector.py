...
def filter_system_sdn_connector_data(json):
    option_list = ['access_key', 'api_key', 'azure_region',
                   ...
                   'ibm_region_gen1', 'ibm_region_gen2', 'key_passwd',
                   'login_endpoint', 'name', 'nic',
                   'oci_cert', 'oci_fingerprint', 'oci_region',
                   'oci_region_type', 'password', 'private_key',
                   ...
                   'vcenter_password', 'vcenter_server', 'vcenter_username',
                   'vpc_id']
    dictionary = {}
