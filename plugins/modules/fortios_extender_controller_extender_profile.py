...
def filter_extender_controller_extender_profile_data(json):
    option_list = ['allowaccess', 'bandwidth_limit', 'cellular',
                   'enforce_bandwidth', 'extension', 'id',
                   'lan_extension', 'login_password', 'login_password_change',
                   'model', 'name']
    dictionary = {}
...
def flatten_multilists_attributes(data):
    multilist_attrs = [
        [u'allowaccess'],
        [u'cellular', u'modem1', u'auto_switch', u'switch_back'],
        [u'cellular', u'modem2', u'auto_switch', u'switch_back'],
        [u'cellular', u'sms_notification', u'receiver', u'alert'],
    ]
...
def main():
    ...
    for attribute_name in module_spec['options']:
        fields["extender_controller_extender_profile"]['options'][attribute_name] = module_spec['options'][attribute_name]
        if mkeyname and mkeyname == attribute_name:
            fields["extender_controller_extender_profile"]['options'][attribute_name]['required'] = True
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(fos, versioned_schema, "extender_controller_extender_profile")
