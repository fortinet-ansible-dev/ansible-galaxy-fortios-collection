...
def filter_system_interface_data(json):
    option_list = ['ac_name', 'aggregate', 'algorithm',
                   ...
                   'switch_controller_igmp_snooping', 'switch_controller_learning_limit', 'tagging',
    ...
    fields = {
        ...
        "system_interface": {
            ...
            "options": {
                ...
                "icmp_redirect": {"required": False, "type": "str",
                                  "choices": ["enable",
                                              "disable"]},
