...
def filter_system_interface_data(json):
    option_list = ['ac_name', 'aggregate', 'algorithm',
                   ...
                   'dhcp_relay_ip', 'dhcp_relay_service', 'dhcp_relay_type',
                   'dhcp_renew_time', 'disc_retry_timeout', 'disconnect_threshold',
                   ...
                   'switch_controller_traffic_policy', 'tagging', 'tcp_mss',
                   'trust_ip_1', 'trust_ip_2', 'trust_ip_3',
                   'trust_ip6_1', 'trust_ip6_2', 'trust_ip6_3',
                   'type', 'username', 'vdom',
                   'vindex', 'vlan_protocol', 'vlanforward',
                   'vlanid', 'vrf', 'vrrp',
