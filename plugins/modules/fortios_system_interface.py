...
def filter_system_interface_data(json):
    option_list = ['ac_name', 'aggregate', 'algorithm',
                   ...
                   'arpforward', 'auth_cert', 'auth_portal_addr',
                   'auth_type', 'auto_auth_extension_device', 'bandwidth_measure_time',
                   'bfd', 'bfd_desired_min_tx', 'bfd_detect_mult',
                   'bfd_required_min_rx', 'broadcast_forticlient_discovery', 'broadcast_forward',
                   'captive_portal', 'cli_conn_status', 'client_options',
                   'color', 'dedicated_to', 'defaultgw',
                   'description', 'detected_peer_mtu', 'detectprotocol',
                   'detectserver', 'device_access_list', 'device_identification',
                   'device_identification_active_scan', 'device_netscan', 'device_user_identification',
                   'devindex', 'dhcp_classless_route_addition', 'dhcp_client_identifier',
                   'dhcp_relay_agent_option', 'dhcp_relay_interface', 'dhcp_relay_interface_select_method',
                   'dhcp_relay_ip', 'dhcp_relay_link_selection', 'dhcp_relay_request_all_server',
                   'dhcp_relay_service', 'dhcp_relay_type', 'dhcp_renew_time',
                   'dhcp_snooping_server_list', 'disc_retry_timeout', 'disconnect_threshold',
                   'distance', 'dns_server_override', 'dns_server_protocol',
                   ...
                   'priority_override', 'proxy_captive_portal', 'reachable_time',
                   ...
                   'status', 'stp', 'stp_ha_secondary',
                   'stp_ha_slave', 'stpforward', 'stpforward_mode',
                   'subst', 'substitute_dst_mac', 'swc_first_create',
                   'swc_vlan', 'switch', 'switch_controller_access_vlan',
                   'switch_controller_arp_inspection', 'switch_controller_dhcp_snooping', 'switch_controller_dhcp_snooping_option82',
                   'switch_controller_dhcp_snooping_verify_mac', 'switch_controller_dynamic', 'switch_controller_feature',
                   'switch_controller_igmp_snooping', 'switch_controller_igmp_snooping_fast_leave', 'switch_controller_igmp_snooping_proxy',
                   'switch_controller_iot_scanning', 'switch_controller_learning_limit', 'switch_controller_mgmt_vlan',
                   'switch_controller_nac', 'switch_controller_rspan_mode', 'switch_controller_source_ip',
                   'switch_controller_traffic_policy', 'system_id', 'system_id_type',
...
def flatten_multilists_attributes(data):
    multilist_attrs = [
        ...
        [u'vrrp', u'vrdst'],
        [u'dhcp_relay_ip'],
        [u'ipv6', u'vrrp6', u'vrdst6'],
        [u'ipv6', u'dhcp6_relay_ip'],
        [u'ipv6', u'ip6_delegated_prefix_list', u'rdnss'],
        [u'ipv6', u'dhcp6_client_options'],
        [u'ipv6', u'ip6_allowaccess'],
        [u'ipv6', u'ip6_prefix_list', u'rdnss'],
        [u'dns_server_protocol'],
        [u'fail_detect_option'],
        [u'client_options', u'ip'],
        [u'allowaccess'],
