...
def filter_system_speed_test_schedule_data(json):
    option_list = ['diffserv', 'interface', 'schedules',
                   'server_name', 'status', 'update_inbandwidth',
                   'update_inbandwidth_maximum', 'update_inbandwidth_minimum', 'update_outbandwidth',
                   'update_outbandwidth_maximum', 'update_outbandwidth_minimum']
    dictionary = {}
