...
def filter_firewall_access_proxy_data(json):
    option_list = ['api_gateway', 'api_gateway6', 'auth_portal',
                   'auth_virtual_host', 'client_cert', 'decrypted_traffic_mirror',
                   'empty_cert_action', 'ldb_method', 'log_blocked_traffic',
                   'name', 'realservers', 'server_pubkey_auth',
                   'server_pubkey_auth_settings', 'vip']
    dictionary = {}
