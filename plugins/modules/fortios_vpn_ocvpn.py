...
short_description: Configure One-Click VPN settings in Fortinet's FortiOS and FortiGate.
description:
...
options:
    ...
    vpn_ocvpn:
        ...
        suboptions:
            ...
            status:
                description:
                    - Enable/disable One-Click cloud assisted VPN.
                type: str
                choices:
                    - enable
                    - disable
...
def filter_vpn_ocvpn_data(json):
    option_list = ['auto_discovery', 'eap', 'eap_users',
                   'forticlient_access', 'ha_alias', 'ip_allocation_block',
                   'multipath', 'nat', 'overlays',
                   'poll_interval', 'role', 'sdwan',
                   'status', 'subnets', 'wan_interface']
    dictionary = {}
