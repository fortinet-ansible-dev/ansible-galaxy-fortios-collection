...
def filter_wireless_controller_apcfg_profile_data(json):
    option_list = ['ac_ip', 'ac_port', 'ac_timer',
                   'ac_type', 'ap_family', 'command_list',
                   'comment', 'name']
    dictionary = {}
...
def wireless_controller_apcfg_profile(data, fos, check_mode=False):
    ...
    if check_mode:
        mkey = fos.get_mkey('wireless-controller', 'apcfg-profile', filtered_data, vdom=vdom)
        current_data = fos.get('wireless-controller', 'apcfg-profile', vdom=vdom, mkey=mkey)
