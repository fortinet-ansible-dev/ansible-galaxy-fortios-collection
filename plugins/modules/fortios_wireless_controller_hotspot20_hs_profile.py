...
def filter_wireless_controller_hotspot20_hs_profile_data(json):
    option_list = ['plmn_3gpp', 'access_network_asra', 'access_network_esr',
                   ...
                   'advice_of_charge', 'anqp_domain_id', 'bss_transition',
                   'conn_cap', 'deauth_request_timeout', 'dgaf',
                   'domain_name', 'gas_comeback_delay', 'gas_fragmentation_limit',
                   'hessid', 'ip_addr_type', 'l2tif',
                   'nai_realm', 'name', 'network_auth',
                   'oper_friendly_name', 'oper_icon', 'osu_provider',
                   'osu_provider_nai', 'osu_ssid', 'pame_bi',
                   'proxy_arp', 'qos_map', 'release',
                   'roaming_consortium', 'terms_and_conditions', 'venue_group',
                   'venue_name', 'venue_type', 'venue_url',
...
def main():
    ...
    for attribute_name in module_spec['options']:
        fields["wireless_controller_hotspot20_hs_profile"]['options'][attribute_name] = module_spec['options'][attribute_name]
        if mkeyname and mkeyname == attribute_name:
            fields["wireless_controller_hotspot20_hs_profile"]['options'][attribute_name]['required'] = True
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(fos, versioned_schema, "wireless_controller_hotspot20_hs_profile")
