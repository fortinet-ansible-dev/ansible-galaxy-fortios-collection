...
def wireless_controller_hotspot20_hs_profile(data, fos, check_mode=False):
    ...
    if check_mode:
        mkey = fos.get_mkey('wireless_controller_hotspot20', 'hs_profile', filtered_data, vdom=vdom)
        current_data = fos.get('wireless_controller_hotspot20', 'hs_profile', vdom=vdom, mkey=mkey)
...
def fortios_wireless_controller_hotspot20(data, fos, check_mode):
    ...
    fos.do_member_operation('wireless_controller_hotspot20_hs_profile')
