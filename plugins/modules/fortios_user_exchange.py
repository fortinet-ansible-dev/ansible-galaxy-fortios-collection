...
def filter_user_exchange_data(json):
    option_list = ['addr_type', 'auth_level', 'auth_type',
                   'auto_discover_kdc', 'connect_protocol', 'domain_name',
                   'http_auth_type', 'ip', 'ip6',
                   'kdc_ip', 'name', 'password',
                   'server_name', 'ssl_min_proto_version', 'username']
    dictionary = {}
