...
def filter_firewall_gtp_data(json):
    option_list = ['addr_notify', 'apn', 'apn_filter',
                   ...
                   'handover_group6', 'ie_remove_policy', 'ie_remover',
                   'ie_validation', 'ie_white_list_v0v1', 'ie_white_list_v2',
                   'imsi', 'imsi_filter', 'interface_notify',
                   'invalid_reserved_field', 'invalid_sgsns_to_log', 'invalid_sgsns6_to_log',
                   'ip_filter', 'ip_policy', 'log_freq',
                   'log_gtpu_limit', 'log_imsi_prefix', 'log_msisdn_prefix',
                   'max_message_length', 'message_filter_v0v1', 'message_filter_v2',
                   'message_rate_limit', 'message_rate_limit_v0', 'message_rate_limit_v1',
                   'message_rate_limit_v2', 'min_message_length', 'miss_must_ie',
                   'monitor_mode', 'name', 'noip_filter',
                   'noip_policy', 'out_of_state_ie', 'out_of_state_message',
                   'per_apn_shaper', 'policy', 'policy_filter',
                   'policy_v2', 'port_notify', 'rate_limit_mode',
