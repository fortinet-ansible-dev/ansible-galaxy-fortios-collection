...
def fortios_webfilter(data, fos):
    ...
    fos.do_member_operation('webfilter_fortiguard')
...
def main():
    ...
    for attribute_name in module_spec['options']:
        fields["webfilter_fortiguard"]['options'][attribute_name] = module_spec['options'][attribute_name]
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(fos, versioned_schema, "webfilter_fortiguard")
