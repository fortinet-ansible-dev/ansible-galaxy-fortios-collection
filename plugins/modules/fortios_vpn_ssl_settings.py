  ...
  - name: Configure SSL VPN.
    fortios_vpn_ssl_settings:
      ...
      vpn_ssl_settings:
        ...
        source_address:
         -
            name: "default_name_63 (source firewall.address.name firewall.addrgrp.name)"
        source_address_negate: "enable"
        source_address6:
         -
            name: "default_name_66 (source firewall.address6.name firewall.addrgrp6.name)"
        source_address6_negate: "enable"
        source_interface:
         -
        ...
        tunnel_ip_pools:
         -
            name: "default_name_83 (source firewall.address.name firewall.addrgrp.name)"
        tunnel_ipv6_pools:
         -
            name: "default_name_85 (source firewall.address6.name firewall.addrgrp6.name)"
        tunnel_user_session_timeout: "86"
...
def filter_vpn_ssl_settings_data(json):
    option_list = ['algorithm', 'auth_session_check_source_ip', 'auth_timeout',
                   ...
                   'ssl_max_proto_ver', 'ssl_min_proto_ver', 'sslv3',
                   'tlsv1_0', 'tlsv1_1', 'tlsv1_2',
                   'tlsv1_3', 'transform_backward_slashes', 'tunnel_connect_without_reauth',
                   'tunnel_ip_pools', 'tunnel_ipv6_pools', 'tunnel_user_session_timeout',
