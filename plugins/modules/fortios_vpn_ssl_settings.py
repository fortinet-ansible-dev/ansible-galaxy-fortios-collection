...
def filter_vpn_ssl_settings_data(json):
    option_list = ['algorithm', 'auth_session_check_source_ip', 'auth_timeout',
                   ...
                   'check_referer', 'client_sigalgs', 'default_portal',
                   'deflate_compression_level', 'deflate_min_data_size', 'dns_server1',
                   'dns_server2', 'dns_suffix', 'dtls_hello_timeout',
                   'dtls_max_proto_ver', 'dtls_min_proto_ver', 'dtls_tunnel',
                   'encode_2f_sequence', 'encrypt_and_store_password', 'force_two_factor_auth',
                   'header_x_forwarded_for', 'hsts_include_subdomains', 'http_compression',
                   ...
                   'ssl_max_proto_ver', 'ssl_min_proto_ver', 'tlsv1_0',
                   'tlsv1_1', 'tlsv1_2', 'tlsv1_3',
                   'transform_backward_slashes', 'tunnel_connect_without_reauth', 'tunnel_ip_pools',
