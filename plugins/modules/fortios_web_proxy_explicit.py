...
def fortios_web_proxy(data, fos):
    ...
    fos.do_member_operation('web_proxy_explicit')
...
def main():
    ...
    for attribute_name in module_spec['options']:
        fields["web_proxy_explicit"]['options'][attribute_name] = module_spec['options'][attribute_name]
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(fos, versioned_schema, "web_proxy_explicit")
