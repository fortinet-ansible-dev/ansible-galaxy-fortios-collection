                ...
                suboptions:
                    ...
                    sla:
                        ...
                        suboptions:
                            health_check:
                                description:
                                    - Virtual WAN Link health-check. Source system.sdwan.health-check.name.
                                type: str
                            id:
                                description:
                                    - SLA ID.
      ...
      system_sdwan:
        ...
        health_check:
         -
            ...
            members:
             -
                seq_num: "17 (source system.sdwan.members.seq-num)"
        ...
        neighbor:
         -
            ...
            member: "66 (source system.sdwan.members.seq-num)"
            role: "standalone"
            sla_id: "68"
        ...
        service:
         -
            ...
            health_check:
             -
                name: "default_name_90 (source system.sdwan.health-check.name)"
            hold_down_time: "91"
            id:  "92"
            input_device:
             -
            ...
            internet_service_app_ctrl_group:
             -
                name: "default_name_100 (source application.group.name)"
            internet_service_custom:
             -
                name: "default_name_102 (source firewall.internet-service-custom.name)"
            internet_service_custom_group:
             -
                name: "default_name_104 (source firewall.internet-service-custom-group.name)"
            internet_service_group:
             -
                name: "default_name_106 (source firewall.internet-service-group.name)"
            internet_service_name:
             -
            ...
            latency_weight: "110"
            link_cost_factor: "latency"
            link_cost_threshold: "112"
            mode: "auto"
            name: "default_name_114"
            packet_loss_weight: "115"
            priority_members:
             -
                seq_num: "117 (source system.sdwan.members.seq-num)"
            protocol: "118"
            quality_link: "119"
            role: "standalone"
            route_tag: "121"
