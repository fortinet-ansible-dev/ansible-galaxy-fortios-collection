  ...
  - name: Configure FortiGuard services.
    fortios_system_fortiguard:
      ...
      system_fortiguard:
        ...
        webfilter_cache_ttl: "42"
        webfilter_expiration: "43"
        webfilter_force_off: "enable"
        webfilter_license: "45"
        webfilter_timeout: "46"
...
def filter_system_fortiguard_data(json):
    option_list = ['antispam_cache', 'antispam_cache_mpercent', 'antispam_cache_ttl',
                   ...
                   'port', 'protocol', 'proxy_password',
                   'proxy_server_ip', 'proxy_server_port', 'proxy_username',
                   'sandbox_region', 'sdns_options', 'sdns_server_ip',
                   'sdns_server_port', 'service_account_id', 'source_ip',
                   'source_ip6', 'update_server_location', 'webfilter_cache',
                   'webfilter_cache_ttl', 'webfilter_expiration', 'webfilter_force_off',
                   'webfilter_license', 'webfilter_timeout']
    dictionary = {}
