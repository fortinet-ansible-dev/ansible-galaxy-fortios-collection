...
def filter_wireless_controller_arrp_profile_data(json):
    option_list = ['comment', 'darrp_optimize', 'darrp_optimize_schedules',
                   'include_dfs_channel', 'include_weather_channel', 'monitor_period',
                   'name', 'override_darrp_optimize', 'selection_period',
