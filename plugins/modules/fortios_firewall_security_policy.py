  ...
  - name: Configure NGFW IPv4/IPv6 application policies.
    fortios_firewall_security_policy:
      ...
      firewall_security_policy:
        ...
        dstaddr4:
         -
            name: "default_name_19 (source firewall.address.name firewall.addrgrp.name firewall.vip.name firewall.vipgrp.name)"
        dstaddr6:
         -
            name: "default_name_21 (source firewall.address6.name firewall.addrgrp6.name firewall.vip6.name firewall.vipgrp6.name)"
        dstintf:
         -
            name: "default_name_23 (source system.interface.name system.zone.name)"
        emailfilter_profile: "<your_own_value> (source emailfilter.profile.name)"
        enforce_default_app_port: "enable"
        file_filter_profile: "<your_own_value> (source file-filter.profile.name)"
        fsso_groups:
         -
            name: "default_name_28 (source user.adgrp.name)"
        ...
        internet_service_name:
         -
            name: "default_name_43 (source firewall.internet-service-name.name)"
        internet_service_negate: "enable"
        internet_service_src: "enable"
        internet_service_src_custom:
         -
            name: "default_name_47 (source firewall.internet-service-custom.name)"
        internet_service_src_custom_group:
         -
            name: "default_name_49 (source firewall.internet-service-custom-group.name)"
        internet_service_src_group:
         -
            name: "default_name_51 (source firewall.internet-service-group.name)"
        internet_service_src_id:
         -
            id:  "53 (source firewall.internet-service.id)"
        internet_service_src_name:
         -
        ...
        service:
         -
            name: "default_name_68 (source firewall.service.custom.name firewall.service.group.name)"
        service_negate: "enable"
        srcaddr:
         -
            name: "default_name_71 (source firewall.address.name firewall.addrgrp.name system.external-resource.name)"
        srcaddr4:
         -
            name: "default_name_73 (source firewall.address.name firewall.addrgrp.name)"
        srcaddr6:
         -
            name: "default_name_75 (source firewall.address6.name firewall.addrgrp6.name)"
        srcintf:
         -
            name: "default_name_77 (source system.interface.name system.zone.name)"
...
def filter_firewall_security_policy_data(json):
    option_list = ['action', 'app_category', 'app_group',
                   ...
                   'dnsfilter_profile', 'dstaddr', 'dstaddr4',
                   'dstaddr6', 'dstintf', 'emailfilter_profile',
                   'enforce_default_app_port', 'file_filter_profile', 'fsso_groups',
                   'global_label', 'groups', 'icap_profile',
                   ...
                   'internet_service_src_name', 'internet_service_src_negate', 'ips_sensor',
                   ...
                   'srcaddr4', 'srcaddr6', 'srcintf',
                   'ssh_filter_profile', 'ssl_ssh_profile', 'status',
                   'url_category', 'users', 'utm_status',
                   'uuid', 'uuid_idx', 'voip_profile',
                   'webfilter_profile']
    dictionary = {}
