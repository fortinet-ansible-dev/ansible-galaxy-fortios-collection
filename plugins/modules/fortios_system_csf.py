...
def filter_system_csf_data(json):
    option_list = ['accept_auth_by_cert', 'authorization_request_type', 'certificate',
                   ...
                   'fabric_workers', 'fixed_key', 'forticloud_account_enforcement',
                   'group_name', 'group_password', 'log_unification',
                   'management_ip', 'management_port', 'saml_configuration_sync',
                   'status', 'trusted_list', 'upstream',
