...
versioned_schema = {
    ...
    "children": {
        ...
        "collectors": {
            ...
            "type": "list",
            "children": {
                "ip": {"type": "string", "revisions": {"v7.2.0": True}},
                "name": {"type": "string", "revisions": {"v7.2.0": True}},
                "transport": {
                    "type": "string",
                    "options": [
                        {"value": "udp", "revisions": {"v7.2.0": True}},
                        {"value": "tcp", "revisions": {"v7.2.0": True}},
                        {"value": "sctp", "revisions": {"v7.2.0": True}},
                    ],
                    "revisions": {"v7.2.0": True},
                },
                "port": {"type": "integer", "revisions": {"v7.2.0": True}},
            },
            "revisions": {
                "v7.0.3": False,
                "v7.0.2": False,
