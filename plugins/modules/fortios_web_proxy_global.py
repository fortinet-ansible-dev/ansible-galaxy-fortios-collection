...
def filter_web_proxy_global_data(json):
    option_list = ['fast_policy_match', 'forward_proxy_auth', 'forward_server_affinity_timeout',
                   'ldap_user_cache', 'learn_client_ip', 'learn_client_ip_from_header',
                   'learn_client_ip_srcaddr', 'learn_client_ip_srcaddr6', 'max_message_length',
                   'max_request_length', 'max_waf_body_cache_length', 'proxy_fqdn',
                   'src_affinity_exempt_addr', 'src_affinity_exempt_addr6', 'ssl_ca_cert',
...
def flatten_multilists_attributes(data):
    multilist_attrs = [
        ...
        [u'src_affinity_exempt_addr6'],
        [u'src_affinity_exempt_addr'],
    ]
