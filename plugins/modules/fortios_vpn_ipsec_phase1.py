        ...
        suboptions:
            ...
            proposal:
                ...
                choices:
                    ...
                    - aes256gcm_prfsha384
                    - aes256gcm_prfsha512
                    - chacha20poly1305_prfsha1
                    - chacha20poly1305_prfsha256
                    - chacha20poly1305_prfsha384
                    - chacha20poly1305_prfsha512
            psksecret:
                description:
            ...
            wizard_type:
                ...
                choices:
                    ...
                    - static_cisco
                    - dialup_cisco_fw
                    - simplified_static_fortigate
                    - hub_fortigate_auto_discovery
                    - spoke_fortigate_auto_discovery
            xauthtype:
                description:
                    - XAuth type.
                type: str
  ...
  - name: Configure VPN remote gateway.
    fortios_vpn_ipsec_phase1:
      ...
      vpn_ipsec_phase1:
        ...
        certificate:
         -
            name: "default_name_20 (source vpn.certificate.local.name)"
...
def filter_vpn_ipsec_phase1_data(json):
    option_list = ['acct_verify', 'add_gw_route', 'add_route',
                   ...
                   'mode_cfg', 'name', 'nattraversal',
                   'negotiate_timeout', 'network_id', 'network_overlay',
                   'npu_offload', 'peer', 'peergrp',
                   'peerid', 'peertype', 'ppk',
