...
def filter_user_saml_data(json):
    option_list = ['adfs_claim', 'cert', 'clock_tolerance',
                   'digest_method', 'entity_id', 'group_claim_type',
                   'group_name', 'idp_cert', 'idp_entity_id',
                   'idp_single_logout_url', 'idp_single_sign_on_url', 'limit_relaystate',
                   'name', 'single_logout_url', 'single_sign_on_url',
                   'user_claim_type', 'user_name']
    dictionary = {}
