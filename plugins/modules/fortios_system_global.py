...
def filter_system_global_data(json):
    option_list = ['admin_concurrent', 'admin_console_timeout', 'admin_hsts_max_age',
                   ...
                   'dnsproxy_worker_count', 'dst', 'edit_vdom_prompt',
                   'endpoint_control_fds_access', 'endpoint_control_portal_port', 'failtime',
                   'faz_disk_buffer_size', 'fds_statistics', 'fds_statistics_period',
                   'fec_port', 'fgd_alert_subscription', 'fortiextender',
                   'fortiextender_data_port', 'fortiextender_vlan_mode', 'fortiipam_integration',
                   'fortiservice_port', 'fortitoken_cloud', 'gui_allow_default_hostname',
                   'gui_certificates', 'gui_custom_language', 'gui_date_format',
                   'gui_date_time_source', 'gui_device_latitude', 'gui_device_longitude',
                   'gui_display_hostname', 'gui_firmware_upgrade_warning', 'gui_forticare_registration_setup_warning',
                   'gui_fortisandbox_cloud', 'gui_ipv6', 'gui_lines_per_page',
                   'gui_theme', 'gui_wireless_opensecurity', 'honor_df',
                   'hostname', 'igmp_state_limit', 'interval',
                   'ip_src_port_range', 'ips_affinity', 'ipsec_asic_offload',
                   'ipsec_hmac_offload', 'ipsec_soft_dec_async', 'ipv6_accept_dad',
                   'ipv6_allow_anycast_probe', 'irq_time_accounting', 'language',
                   ...
                   'proxy_hardware_acceleration', 'proxy_kxp_hardware_acceleration', 'proxy_re_authentication_mode',
