  ...
  - name: Configure global attributes.
    fortios_system_global:
      ...
      system_global:
        ...
        max_dlpstat_memory: "116"
        max_route_cache_size: "117"
        mc_ttl_notchange: "enable"
        memory_use_threshold_extreme: "119"
        memory_use_threshold_green: "120"
        memory_use_threshold_red: "121"
        miglog_affinity: "<your_own_value>"
        miglogd_children: "123"
        multi_factor_authentication: "optional"
        multicast_forward: "enable"
        ndp_max_entry: "126"
        per_user_bwl: "enable"
        policy_auth_concurrent: "128"
        post_login_banner: "disable"
        pre_login_banner: "enable"
        private_data_encryption: "disable"
        proxy_auth_lifetime: "enable"
        proxy_auth_lifetime_timeout: "133"
        proxy_auth_timeout: "134"
        ...
        proxy_worker_count: "139"
        radius_port: "140"
        reboot_upon_config_restore: "enable"
        refresh: "142"
        remoteauthtimeout: "143"
        ...
        virtual_server_count: "196"
        virtual_server_hardware_acceleration: "disable"
        wad_affinity: "<your_own_value>"
        wad_csvc_cs_count: "199"
        wad_csvc_db_count: "200"
        wad_memory_change_granularity: "201"
        wad_source_affinity: "disable"
        wad_worker_count: "203"
...
def filter_system_global_data(json):
    option_list = ['admin_concurrent', 'admin_console_timeout', 'admin_hsts_max_age',
                   ...
                   'fortiservice_port', 'fortitoken_cloud', 'fortitoken_cloud_service',
                   'gui_allow_default_hostname', 'gui_certificates', 'gui_custom_language',
                   'gui_date_format', 'gui_date_time_source', 'gui_device_latitude',
                   'gui_device_longitude', 'gui_display_hostname', 'gui_firmware_upgrade_setup_warning',
                   'gui_firmware_upgrade_warning', 'gui_fortisandbox_cloud', 'gui_ipv6',
                   ...
                   'ipv6_accept_dad', 'ipv6_allow_anycast_probe', 'irq_time_accounting',
                   ...
                   'proxy_re_authentication_mode', 'proxy_worker_count', 'radius_port',
                   'reboot_upon_config_restore', 'refresh', 'remoteauthtimeout',
                   'reset_sessionless_tcp', 'restart_time', 'revision_backup_on_logout',
                   'revision_image_auto_backup', 'scanunit_count', 'security_rating_result_submission',
                   'security_rating_run_on_schedule', 'send_pmtu_icmp', 'snat_route_change',
                   'special_file_23_support', 'split_port', 'ssd_trim_date',
