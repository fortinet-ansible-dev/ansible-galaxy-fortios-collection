    ...
    endpoint_control_fctems:
        ...
        suboptions:
            ...
            fortinetone_cloud_authentication:
                description:
                    - Enable/disable authentication of FortiClient EMS Cloud through FortinetOne account.
                type: str
                choices:
                    - enable
                    - disable
...
def filter_endpoint_control_fctems_data(json):
    option_list = ['admin_password', 'admin_username', 'call_timeout',
                   'certificate', 'cloud_server_type', 'fortinetone_cloud_authentication',
                   'https_port', 'name', 'pull_avatars',
